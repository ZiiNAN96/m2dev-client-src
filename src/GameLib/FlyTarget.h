...
public:
	...
	virtual Math::Vector3 OnGetFlyTargetPosition() = 0;
...
public:
	...
	CFlyTarget(const Math::Vector3& v3FlyTargetPosition);
	...
	const Math::Vector3 & GetFlyTargetPosition() const;
	EType GetType();
...
private:
	mutable Math::Vector3 m_v3FlyTargetPosition;
