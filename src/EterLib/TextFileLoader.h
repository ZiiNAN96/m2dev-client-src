...
class CTextFileLoader
{
	...
	public:
		...
		BOOL GetTokenVector2(const std::string & c_rstrKey, Math::Vector2 * pVector2);
		BOOL GetTokenVector3(const std::string & c_rstrKey, Math::Vector3 * pVector3);
		BOOL GetTokenVector4(const std::string & c_rstrKey, Math::Vector4 * pVector4);

		BOOL GetTokenPosition(const std::string & c_rstrKey, Math::Vector3 * pVector);
		BOOL GetTokenQuaternion(const std::string & c_rstrKey, Math::Quaternion * pQ);
		BOOL GetTokenDirection(const std::string & c_rstrKey, Math::Vector3 * pVector);
		BOOL GetTokenColor(const std::string & c_rstrKey, Math::Color * pColor);
