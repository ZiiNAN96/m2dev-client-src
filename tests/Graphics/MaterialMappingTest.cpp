...
int main()
{
    try {
        ...
        Check(material.model==MaterialModel::PBRMetallicRoughness && material.metallic==1 && material.roughness==1,"glTF absent PBR defaults");
        ...
        Check(legacy.model==MaterialModel::Legacy&&legacy.metallic==0&&legacy.roughness==.85f,"matte dielectric GR2 default");
